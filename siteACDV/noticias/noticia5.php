        ...
        <div class="maxwidth">
            ...
            <div id="conteudopag">
                ...
                <div class="section group">
                    ...
                    <div class="jobs">
                        <img src="../imagens/noticia5.jpg" alt="Menino usando um óculos de realidade virtual" width="500" height="386" class="fotonoticias" />
                        <a href="" class="noticia">
                            <h3 class="jobs1">Servidor com deficiência visual deverá ser movido para local próximo à residência </h3>
                            <p>
                                Servidor público do Distrito Federal com deficiência visual terá que ser movido para local próximo
                                à residência. Isso sempre deverá acontecer quando demonstrada a existência de vaga e não houver
                                prejuízo para a Administração Pública. Segundo o Tribunal de Justiça do Distrito Federal e
                                Territórios o entendimento foi firmado pela 6ª Turma Cível do TJDFT.<br />
                                Na origem, a autora, que é servidora pública distrital dos quadros da Secretaria de Saúde, informa
                                que a redução da visão e o comprometimento bilateral do campo visual a impossibilitaram de se
                                locomover sozinha por transporte público e de dirigir. Ela narra que solicitou ao GDF que a
                                removesse para um hospital mais próximo à sua casa, mas o pedido foi negado. Por conta disso,
                                a servidora buscou o Poder Judiciário e juntou aos autos laudo médico pericial que aponta a
                                necessidade de laborar em local próximo à moradia.
                                <br />
                                Em primeira instância, o juiz da 3º Vara da Fazenda Pública julgou o pedido procedente e determinou
                                que o Distrito Federal promovesse a readaptação da servidora para uma unidade de trabalho próximo de
                                sua casa. O DF apelou da sentença, alegando que, por força da separação dos poderes, não cabe ao Poder
                                Judiciário exarar provimento alterando a lotação de servidor público local.
                                <br />
                                <p><a href="https://jornaldebrasilia.com.br/cidades/servidor-com-deficiencia-visual-devera-ser-movido-para-local-proximo-a-residencia/" target="_blank">
