    ...
    <div id="container">
        ...
        <div class="maxwidth">
            ...
            <div id="conteudopag">
                ...
                <div class="itemmapa">
                    <span class="titmapa"><a href="index.php">Página Inicial</a></span>
                    <hr>
                    Homepage com destaques de conteúdo do site.
                </div>

                <div class="itemmapa">
                    <span class="titmapa"><a href="quemsomos.php">Quem Somos</a></span>
                    <hr>
                    <ul style="margin:0 0 0 5%; padding:0 0 0 5%;">
                        <li>O Projeto</li>
                        <li>A Importância da Acessibilidade</li>
                        <li>Nossa Missão</li>
                    </ul>
                </div>

                <div class="itemmapa">
                    <span class="titmapa"><a href="noticias.php">Notícias</a></span>
                    <hr>
                    <ul style="margin:0 0 0 5%; padding:0 0 0 5%;">
                        <li>Últimas notícias referentes a ACDV</li>
                        <li>Notícias em geral, úteis para acessibilidade</li>
                    </ul>
                </div>

                <div class="itemmapa">
                    <span class="titmapa"><a href="atividades.php">Atividades</a></span>
                    <hr>
                    <ul style="margin:0 0 0 5%; padding:0 0 0 5%;">
                        <li>Braile</li>
                        <li>Informática adaptada à acessibilidade</li>
                        <li>Culinária</li>
                        <li>Artesanato</li>
                        <li>Crianças</li>                        
                    </ul>
                ...
                <div class="itemmapa">
                    <span class="titmapa"><a href="doar.php">Doar</a></span>
                    <hr>
                    <ul style="margin:0 0 0 5%; padding:0 0 0 5%;">
                        <li>Dados para doação em conta bancária e Paypal</li>                        
                    </ul>
                </div>

                <div class="itemmapa">
                    <span class="titmapa"><a href="/contato.php">Contato</a></span>
                    <hr>
                    Entre em contato conosco, será um prazer ouví-lo.</div>


                <div class="itemmapa2">
                    <span class="titmapa"><a href="/acessibilidadedestesite.php">Acessibilidade deste site</a></span>
                    <hr>
                    Conheça os recursos de acessibilidade que este site oferece.
                </div>
