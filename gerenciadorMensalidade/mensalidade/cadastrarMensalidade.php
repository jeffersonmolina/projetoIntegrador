...
<body class="body-bg">
    <div class="horizontal-main-wrapper">
        ...
        <div class="main-content-inner">
            <h3 class="centro text-center">Cadastrar mensalidade</h3>
            <div class="container">
                <div class="row">
                        ...
                        <form>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="inputState">Nome<b>*</b></label>
                                    <select id="inputState" class="form-control">
                                        <option selected>Selecione o associado</option>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="date">Data de pagamento<b>*</b></label>
                                    <input type="date" class="form-control" id="data">
                                </div>
                                <form>
                                    <div class="form-group col-md-6">
                                        <label for="text">Tipo de pagamento<b>*</b></label>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="pagamento1" name="pagamento" class="custom-control-input">
                                            <label class="custom-control-label" for="pagamento1">Dinheiro</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="pagamento2" name="pagamento" class="custom-control-input">
                                            <label class="custom-control-label" for="pagamento2">Cheque</label>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="value">Valor do pagamento<b>*</b></label>
