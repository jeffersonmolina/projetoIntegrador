                                ...
                                <div class="col-md-6 mt-5 mb-3">
                                    <div class="card">
                                        <div class="seo-fact sbg1">
                                            <a href="cadastrarAssociadoFisico.php">
                                                <div class="p-4 d-flex justify-content-between align-items-center">
                                                    <div class="seofct-icon"><i class="fa fa-user-plus"></i>
                                                        Cadastrar Associado Físico
                                                    </div>
                                                    <h2>+</h2>
                                                </div>
                                            </a>
                                ...
                                <div class="col-md-6 mt-md-5 mb-3">
                                    <div class="card">
                                        <div class="seo-fact sbg2">
                                            <a href="listarAssociadoFisico.php">
                                                <div class="p-4 d-flex justify-content-between align-items-center">
                                                    <div class="seofct-icon"><i class="fa fa-th-list"></i>
                                                        Listar Associado Físico
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
