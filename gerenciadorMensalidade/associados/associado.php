                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3 mb-lg-0">
                                <div class="card">
                                    <div class="seo-fact sbg1">
                                        <a href="associadoCrianca.php">
                                            <div class="p-4 d-flex justify-content-between align-items-center">
                                                <div class="seofct-icon">&nbsp &nbsp<i class="fa fa-child"></i>
                                                    &nbsp Cadastrar Criança
                                                </div>
                                                <h2>+</h2>
                                            </div>
                                        </a>
                            ...
                            <div class="col-md-6 mt-3 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg1">
                                        <a href="associadoJuridico.php">
                                            <div class="p-4 d-flex justify-content-between align-items-center">
                                                <div class="seofct-icon"><i class="fa fa-balance-scale"></i>
                                                    Cadastrar Jurídico
                                                </div>
                                                <h2>+</h2>
                                            </div>
