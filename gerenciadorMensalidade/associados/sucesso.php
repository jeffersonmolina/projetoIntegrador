                        ...
                        <div class="col-xl-6 col-ml-10 py-4 col-sm-10 mt-10">
                            <div class="card">
                                <div class="pricing-list">
                                    <div class="prc-head">
                                        <h4 class="bg-success">Cadastrado com Sucesso</h4>
                                    </div>
                                    <div class="prc-list border rounded border-success">
                                        <h3>O associado foi cadastrado com sucesso!</h3>
                                        <a href="associado.php" class="bg-success">Continuar <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
