                            ...
                            <div class="card">
                                <div class="pricing-list">
                                    ...
                                    <div class="prc-list border rounded border-danger">
                                        ...
                                        <h4>Algo de errado aconteceu! <br /> O associado não foi alterado.</h4>
                                        <a href="listarJuridico.php" class="bg-danger">Tentar novamente <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
