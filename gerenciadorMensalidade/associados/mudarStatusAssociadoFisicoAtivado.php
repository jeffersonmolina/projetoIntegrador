            ...
            <div class="main-content-inner">
                <div class="container">
                    <div class="row text-center align-items-center flex-grow-1 justify-content-center">
                        <div class="col-xl-6 col-ml-10 py-4 col-sm-10 mt-10">
                            <div class="card">
                                <div class="pricing-list">
                                    ...
                                    <div class="prc-list border rounded border-success">
                                        ...
                                        <form action="../action/update.php" method="POST">
                                            <input type="hidden" name="idAssociadoFisico" value="<?php echo $_GET['idAssociadoFisico']; ?>">
                                            <button type="submit" name="mudarStatusAtivado" class="btn btn-success">Sim <i class="fa fa-check"></i></button>
                                            <a href="listarAssociadoFisico.php" class="btn btn-secondary">Não <i class="fa fa-arrow-left"></i></a>
                                        </form>
