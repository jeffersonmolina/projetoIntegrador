                        ...
                        <div class="clearfix d-md-inline-block d-block">
                            <div class="user-profile m-0">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="login.php">Sair &nbsp<i class="fa fa-sign-out" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg1">
                                        <a href="associados/associado.php">
                                            <div class="p-4 d-flex justify-content-between align-items-center">
                                                <div class="seofct-icon"><i class="fa fa-group"></i>
                                                    Cadastrar Associado
                                                </div>
                                                <h2>+</h2>
                                            </div>
                            ...
                            <div class="col-md-6 mt-md-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        <a href="mensalidade/cadastrarMensalidade.php">
                                            <div class="p-4 d-flex justify-content-between align-items-center">
                                                <div class="seofct-icon"><i class="fa fa-credit-card"></i>
                            ...
                            <div class="col-md-6 mb-3 mb-lg-0">
                                <div class="card">
                                    <div class="seo-fact sbg3">
                                        <a href="doacoes/cadastrarDoacoes.php">
                                            <div class="p-4 d-flex justify-content-between align-items-center">
                                                <div class="seofct-icon"><i class="fa fa-money"></i>
                                                    Cadastrar Doação
                                                </div>
                                                <h2>+</h2>
                                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="seo-fact sbg4">
                                        <a href="funcionario/cadastrarFuncionario.php">
                                            <div class="p-4 d-flex justify-content-between align-items-center">
                                                <div class="seofct-icon"><i class="fa fa-user"></i>
