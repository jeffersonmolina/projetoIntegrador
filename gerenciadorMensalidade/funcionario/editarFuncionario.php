                            ...
                            <form action="../action/update.php" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="telefone" name="telefone" value="<?php echo $dados['telefone']; ?>" placeholder="Digite o telefone" onkeypress="$(this).mask('(00) 00009-0000')">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="cpf">CPF</label>
                                        <input type="text" class="form-control" id="cpf" name="cpf" value="<?php echo $dados['cpf']; ?>" placeholder="Digite o CPF" minlength="11" maxlength="11" onkeypress="$(this).mask('000.000.000-00')">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-12">
                                        <button type="submit" name="editarFuncionario" class="btn btn-success btn-lg btn-block">Atualizar</button>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-lg-12">
