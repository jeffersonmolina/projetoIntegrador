                            ...
                            <div class="card">
                                <div class="pricing-list">
                                    ...
                                    <div class="prc-list border rounded border-danger">
                                        ...
                                        <h4>Algo de errado aconteceu! <br /> Funcionário não foi cadastrado.</h4>
                                        <a href="cadastrarFuncionario.php" class="bg-danger">Tentar novamente <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
