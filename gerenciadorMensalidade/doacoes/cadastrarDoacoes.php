                            ...
                            <div class="form-row">
                                ...
                                <form>
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="pagamento3" name="pagamento" class="custom-control-input">
                                            <label class="custom-control-label" for="pagamento3">Cartão</label>
                                        </div>
                                    </div>
                                </form>
                            </div>
