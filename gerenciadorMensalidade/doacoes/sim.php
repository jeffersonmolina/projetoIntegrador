                                ...
                                <div class="pricing-list">
                                    ...
                                    <div class="prc-list border rounded border-danger">
                                        ...
                                        <form action="../action/delete.php" method="POST">
                                            <input type="hidden" name="idDoacao" value="<?php echo $_GET['idDoacao']; ?>">
                                            <button type="submit" name="excluirDoacao" value="Sim" class="btn btn-danger">Sim <i class="fa fa-trash"></i></button>
                                            <a href="listarDoacao.php" class="btn btn-secondary">Não <i class="fa fa-arrow-left"></i></a>
                                        </form>
